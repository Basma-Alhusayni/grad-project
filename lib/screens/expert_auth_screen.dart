...
class _ExpertAuthScreenState extends State<ExpertAuthScreen>
  ...
  void dispose() {
    ...
    _reqName.dispose(); _reqEmail.dispose(); _reqCerts.dispose(); _reqExp.dispose();
    super.dispose();
  }
  ...
  Future<void> _login() async {
    ...
    // --- التعديل هنا: استخدام specialistLogin للتأكد من حالة الدخول الأول ---
    ...
    if (res['error'] != null) {
      ...
      if (res['isFirstLogin'] == true) {
        // إذا كان أول دخول (باستخدام كلمة المرور المؤقتة من الإيميل)
        ...
        // إذا كان قد غير كلمة مروره سابقاً
        Navigator.pushAndRemoveUntil(
            context,
  ...
  Future<void> _submitRequest() async {
    ...
    try {
      ...
      // 2. إرسال الطلب عبر AuthService (يتضمن فحص التكرار)
        ...
        child: Directionality(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(children: [
              ...
              const Text('حساب الخبير', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFF14532D))),
              const Text('سجل دخول أو أرسل طلب انضمام', style: TextStyle(color: Colors.grey)),
                  ...
                  if (_tab.index == 0) // --- LOGIN ---
                    Padding(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                        ...
                        GreenButton(label: 'الدخول كخبير', icon: Icons.shield, onPressed: _login, isLoading: _loading),
                        const SizedBox(height: 8),
                      ]),
                    ),
                  ...
                  if (_tab.index == 1) // --- REQUEST ---
                    _requestSent
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                        ...
                        GreenButton(label: 'إرسال طلب الانضمام', icon: Icons.send, onPressed: _submitRequest, isLoading: _loading),
                      ]),
                    ),
                ]),
              ),
